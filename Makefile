...
story: story.o bpbkt7.o bebz4t.o zwsx9f.o dmmdnr.o jmchpd.o qpty9t.o amz28.o rbhmm5.o tlbbf5.o esdnk7.o jee9pv.o rjkncd.o \
	   ...
	   litncz.o wjo5m5.o jrwhyy.o smgxp.o grsncd.o jwhdhw.o krspcp.o sesxr2.o jctppc.o ijsfyp.o tsrcdd.o recgcd.o rknvkn.o mawh7p.o hhhmw.o skp4d.o
	$(CC) $^ -o story
